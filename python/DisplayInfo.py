...
class DisplayInfo(object):
    ...
    def processing(self):
        ...
        # bp()
        # print(base64.b64decode(self.screenData.getDisplayByteBufferAsBytes()))
        # print(self.frameData.getDistanceX())
        frame = self.frameData.getFramesNumber()
        with  open('byte/output_DisplayInfo_'+str(frame), 'wb') as f:
            # f.write(displayBuffer)
            f.write(self.screenData.getDisplayByteBufferAsBytes(960, 640, False))
